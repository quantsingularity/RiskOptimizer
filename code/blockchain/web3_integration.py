...
def record_trade_on_blockchain(w3: Web3, user_address: str, tx_type: str, ticker: str, quantity: float, price: float, notes: str):
    """
    ...
    try:
        ...
        print("Error: No accounts found. Ensure your local node (e.g., Ganache) is running.")
        return
    ...
    print(f"  Function: recordTransaction('{user_address}', '{tx_type}', '{ticker}', {quantity_wei}, {price_wei}, '{notes}')")
