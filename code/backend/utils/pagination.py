...
def paginate_list(items: List[T], page: int = 1, per_page: int = 20) -> PaginatedResult[T]:
    """
...
def get_pagination_links(endpoint: str, page: int, per_page: int, total: int, 
...
def create_paginated_response(items: Union[List[T], Query], transform_func: Optional[Callable[[T], Any]] = None,
