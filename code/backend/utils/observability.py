...
class StructuredLogger:
    ...
    def _create_log_entry(self, level: str, message: str, **kwargs) -> Dict[str, Any]:
        ...
        entry = {
            ...
            "level": level,
            "message": message,
            "correlation_id": correlation_id.get() or getattr(g, 'correlation_id', None),
...
def log_request_end(method: str, path: str, status_code: int, 
...
def log_security_event(event_type: str, severity: str, details: Dict[str, Any], **kwargs) -> None:
    """
    Log security event.
