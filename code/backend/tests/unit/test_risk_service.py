...
class TestRiskService(unittest.TestCase):
    ...
    def test_validate_returns_too_few_elements(self):
        with self.assertRaises(ValidationError):
    ...
    def test_calculate_var_success(self, mock_calculate_var):
    ...
    def test_calculate_cvar_success(self, mock_calculate_cvar):
    ...
    def test_calculate_sharpe_ratio_success(self, mock_calculate_sharpe_ratio):
    ...
    def test_calculate_max_drawdown_success(self):
        ...
        # Expected calculation: (1+0.01)=1.01, (1-0.02)*1.01=0.9898, (1+0.03)*0.9898=1.019494, (1-0.04)*1.019494=0.97871424, (1+0.05)*0.97871424=1.027650
        # Running max: 1.01, 1.01, 1.019494, 1.019494, 1.027650
    ...
    def test_calculate_efficient_frontier_invalid_returns(self):
        with self.assertRaises(ValidationError):
