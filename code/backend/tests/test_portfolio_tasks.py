...
from tasks.celery_app import TaskValidationError, TaskError
...
class TestPortfolioPerformanceAnalysis:
    ...
    def test_performance_analysis_success(self, mock_task_manager):
        ...
        required_metrics = [
            ...
            'sharpe_ratio', 'max_drawdown', 'max_drawdown_duration_days'
        ]
        ...
        required_benchmark_metrics = [
            ...
            'benchmark_volatility', 'benchmark_sharpe', 'excess_return',
        ...
        # Sanity checks
        assert -1 <= perf_summary['max_drawdown'] <= 0  # Max drawdown should be negative
        assert benchmark_comp['beta'] > 0  # Beta should be positive for correlated assets
...
class TestOptimizationHelpers:
    ...
    def test_minimum_variance_optimization(self):
        ...
        equal_weight_var = np.dot(equal_weights.T, np.dot(self.cov_matrix, equal_weights))
...
class TestPortfolioTasksIntegration:
    ...
    def setup_method(self):
        ...
        returns = np.random.multivariate_normal(mean_returns / 252, cov_matrix / 252, n_periods)
...
class TestPortfolioTasksPerformance:
    ...
    def test_optimization_performance_large_universe(self, mock_task_manager):
        ...
        params = {
            'method': 'minimum_variance'  # Usually fastest method
        }
