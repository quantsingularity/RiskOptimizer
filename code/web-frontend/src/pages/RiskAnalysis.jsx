                        ...
                        <CardContent>
                            {tabValue === 0 && (
                                <Box>
                                                ...
                                                <CardContent>
                                                    ...
                                                    <Box>
                                                        ...
                                                        <Typography variant="body2">
                                                            With 95% confidence, your maximum loss
                                                            will not exceed $4,532.12 (3.64% of your
                                                            portfolio) over the next day.
                                                        </Typography>
                                                    </Box>
                                                </CardContent>
                                            </Card>
                                    ...
                                    >
                                        <Typography variant="body2" color="text.secondary">
                                            VaR distribution chart will be implemented with real
                                            data integration
                                        </Typography>
                                    </Box>
                                </Box>
                                ...
                                <Box>
                                    ...
                                    <Grid container spacing={3}>
                                        ...
                                        <Grid item xs={12} md={6}>
                                            ...
                                            >
                                                <Typography variant="body2" color="text.secondary">
                                                    Stress test visualization will be implemented
                            ...
                            {tabValue === 3 && (
                                <Box>
                                    ...
                                    >
                                        <Typography variant="body2" color="text.secondary">
                                            Risk contribution chart will be implemented with real
                                            data integration
                                        </Typography>
                                    </Box>
                                </Box>
