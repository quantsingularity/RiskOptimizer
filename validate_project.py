...
def run_ai_model_tests(project_root):
    ...
    success, _ = run_command("pip install numpy pandas scikit-learn scipy matplotlib joblib pytest", cwd=ai_models_dir)
    if not success:
        return False
    
    # Run training script to validate model
    training_script = os.path.join(ai_models_dir, "training_scripts", "advanced_model_training.py")
...
def main():
    ...
    parser.add_argument("--project-root", default="/home/ubuntu/RiskOptimizer", 
