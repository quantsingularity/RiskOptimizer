        ...
        async (range = selectedRange, interval = selectedInterval) => {
            ...
            try {
                ...
                setAssetData({
                    ...
                    summary: {
                        high:
                            highs.length > 0 ? Math.max(...highs.filter((h) => h !== null)) : null,
                        ...
                        datasets: [
                            {
                                data: simplifiedData,
                                color: (opacity = 1) =>
                                    changePercent >= 0 ? theme.colors.success : theme.colors.error,
                                strokeWidth: 2,
                            },
                        ],
                        legend: [
            ...
            <Card containerStyle={styles.card}>
                ...
                <View style={styles.currentPriceRow}>
                    ...
                    <Text
                        style={[
                            styles.priceChange,
                            summary.change_percentage >= 0 ? styles.positive : styles.negative,
                        ]}
                    >
                        {summary.change_value >= 0 ? '+' : ''}
                        {summary.change_value?.toFixed(2)} ({summary.change_percentage?.toFixed(2)}
                        %)
                    </Text>
                </View>
            </Card>
