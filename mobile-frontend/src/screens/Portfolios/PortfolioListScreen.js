    ...
    >
      ...
      <ListItem.Content>
        ...
        <ListItem.Subtitle style={styles.itemSubtitle}>
          Value: {item.currency} {item.total_value?.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) || '0.00'} | Risk: {item.risk_score?.toFixed(2) || 'N/A'}
        </ListItem.Subtitle>
      </ListItem.Content>
      <ListItem.Chevron />
    </ListItem>
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        ListEmptyComponent={<View style={styles.centered}><Text>No portfolios found. Create one!</Text></View>}
        refreshControl={
