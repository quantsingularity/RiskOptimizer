            ...
            {optimizationResult && (
                <Card containerStyle={styles.card}>
                    ...
                    <Text style={styles.resultText}>
                        Optimized Risk Score: {optimizationResult.optimized_risk_score?.toFixed(2)}{' '}
                        (Current: {optimizationResult.current_risk_score?.toFixed(2)})
                    </Text>
                    <Text style={styles.resultText}>
                        Expected Return: {(optimizationResult.expected_return * 100)?.toFixed(2)}%
                    </Text>
                    <Text style={styles.resultText}>
